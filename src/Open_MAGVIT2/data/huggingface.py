"""
Open_MAGVIT2 wrappers for HuggingFace datasets.
...
class HuggingFaceImageDataset(BaseHuggingFaceImageDataset):
    """
    HuggingFace image dataset with torchvision transforms.
...
class HuggingFaceStreamingDataset(BaseHuggingFaceStreamingDataset):
    """
    HuggingFace streaming dataset with torchvision transforms.
